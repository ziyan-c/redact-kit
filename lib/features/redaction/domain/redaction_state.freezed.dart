...
mixin _$RedactionState {
 ...
 ui.Image? get image; String get status; Color get redactionColor; Offset? get draftStart; Rect? get draftRect; Color? get draftColor; bool get isOpening; bool get isExporting; List<RedactionRegion> get redactions;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RedactionState&&(identical(other.image, image) || other.image == image)&&(identical(other.status, status) || other.status == status)&&(identical(other.redactionColor, redactionColor) || other.redactionColor == redactionColor)&&(identical(other.draftStart, draftStart) || other.draftStart == draftStart)&&(identical(other.draftRect, draftRect) || other.draftRect == draftRect)&&(identical(other.draftColor, draftColor) || other.draftColor == draftColor)&&(identical(other.isOpening, isOpening) || other.isOpening == isOpening)&&(identical(other.isExporting, isExporting) || other.isExporting == isExporting)&&const DeepCollectionEquality().equals(other.redactions, redactions));
}


@override
int get hashCode => Object.hash(runtimeType,image,status,redactionColor,draftStart,draftRect,draftColor,isOpening,isExporting,const DeepCollectionEquality().hash(redactions));

@override
String toString() {
  return 'RedactionState(image: $image, status: $status, redactionColor: $redactionColor, draftStart: $draftStart, draftRect: $draftRect, draftColor: $draftColor, isOpening: $isOpening, isExporting: $isExporting, redactions: $redactions)';
}
...
@useResult
$Res call({
 ui.Image? image, String status, Color redactionColor, Offset? draftStart, Rect? draftRect, Color? draftColor, bool isOpening, bool isExporting, List<RedactionRegion> redactions
});
...
/// Create a copy of RedactionState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? image = freezed,Object? status = null,Object? redactionColor = null,Object? draftStart = freezed,Object? draftRect = freezed,Object? draftColor = freezed,Object? isOpening = null,Object? isExporting = null,Object? redactions = null,}) {
...
as bool,redactions: null == redactions ? _self.redactions : redactions // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ui.Image? image,  String status,  Color redactionColor,  Offset? draftStart,  Rect? draftRect,  Color? draftColor,  bool isOpening,  bool isExporting,  List<RedactionRegion> redactions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RedactionState() when $default != null:
return $default(_that.image,_that.status,_that.redactionColor,_that.draftStart,_that.draftRect,_that.draftColor,_that.isOpening,_that.isExporting,_that.redactions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ui.Image? image,  String status,  Color redactionColor,  Offset? draftStart,  Rect? draftRect,  Color? draftColor,  bool isOpening,  bool isExporting,  List<RedactionRegion> redactions)  $default,) {final _that = this;
switch (_that) {
case _RedactionState():
return $default(_that.image,_that.status,_that.redactionColor,_that.draftStart,_that.draftRect,_that.draftColor,_that.isOpening,_that.isExporting,_that.redactions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ui.Image? image,  String status,  Color redactionColor,  Offset? draftStart,  Rect? draftRect,  Color? draftColor,  bool isOpening,  bool isExporting,  List<RedactionRegion> redactions)?  $default,) {final _that = this;
switch (_that) {
case _RedactionState() when $default != null:
return $default(_that.image,_that.status,_that.redactionColor,_that.draftStart,_that.draftRect,_that.draftColor,_that.isOpening,_that.isExporting,_that.redactions);case _:
  return null;
...
class _RedactionState extends RedactionState {
  const _RedactionState({this.image, this.status = 'Ready', this.redactionColor = const Color(0xFF050505), this.draftStart, this.draftRect, this.draftColor, this.isOpening = false, this.isExporting = false, final  List<RedactionRegion> redactions = const <RedactionRegion>[]}): _redactions = redactions,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RedactionState&&(identical(other.image, image) || other.image == image)&&(identical(other.status, status) || other.status == status)&&(identical(other.redactionColor, redactionColor) || other.redactionColor == redactionColor)&&(identical(other.draftStart, draftStart) || other.draftStart == draftStart)&&(identical(other.draftRect, draftRect) || other.draftRect == draftRect)&&(identical(other.draftColor, draftColor) || other.draftColor == draftColor)&&(identical(other.isOpening, isOpening) || other.isOpening == isOpening)&&(identical(other.isExporting, isExporting) || other.isExporting == isExporting)&&const DeepCollectionEquality().equals(other._redactions, _redactions));
}


@override
int get hashCode => Object.hash(runtimeType,image,status,redactionColor,draftStart,draftRect,draftColor,isOpening,isExporting,const DeepCollectionEquality().hash(_redactions));
...
/// Create a copy of RedactionState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? image = freezed,Object? status = null,Object? redactionColor = null,Object? draftStart = freezed,Object? draftRect = freezed,Object? draftColor = freezed,Object? isOpening = null,Object? isExporting = null,Object? redactions = null,}) {
...
as Color?,isOpening: null == isOpening ? _self.isOpening : isOpening // ignore: cast_nullable_to_non_nullable
as bool,isExporting: null == isExporting ? _self.isExporting : isExporting // ignore: cast_nullable_to_non_nullable
as bool,redactions: null == redactions ? _self._redactions : redactions // ignore: cast_nullable_to_non_nullable
as List<RedactionRegion>,
  ));
}
